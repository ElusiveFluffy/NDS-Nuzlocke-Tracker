...
function ThemeFactory.createSaveThemeForm()
    FormsUtils.createSaveForm(Paths.CURRENT_DIRECTORY.."/nuzlocke_tracker/themes","theme",".colortheme",ThemeFactory.saveFile)
end
...
function ThemeFactory.createLoadThemeForm()
    ...
    local themeFile = forms.openfile("*" .. ending, current_dir .. Paths.SLASH .. "nuzlocke_tracker" .. Paths.SLASH .. "themes")
